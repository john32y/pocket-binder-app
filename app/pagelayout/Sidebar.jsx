...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-row flex-wrap ">
      <ItemList />
      <div className="relative bg-white dark:bg-[#000033 ] bg-opacity-75">
        <div className="flex flex-col sm:flex-row sm:justify-start">
          <div className="h-screen w-72">
            <nav className="px-6 mt-10">
              <a className="flex items-center justify-start p-2 my-6 text-gray-600  bg-gray-50 dark:bg-gray-600 dark:text-gray-400 dark:hover:text-white" href="#">
              ...
              <div>
                <p className="w-full pb-2 mb-4 ml-2 font-normal text-black-100 border-b-2 border-gray-100 text-md">
                  HOME
                </p>
              ...
              <div>
                <p className="w-full pb-2 mb-4 ml-2 font-normal text-black border-b-2 border-gray-100 text-md">
                  PERSONAL
                </p>
                <a className="flex items-center justify-start p-2 my-4 font-thin text-gray-500 transition-colors duration-200 hover:text-gray-800 dark:text-gray-400 hover:bg-gray-100 dark:hover:text-white dark:hover:bg-gray-600" href="#">
                  <span className="text-left">
                ...
                <a className="flex items-center justify-start p-2 my-4 font-thin text-black transition-colors duration-200 hover:text-gray-800 dark:text-gray-400 hover:bg-gray-100 dark:hover:text-white dark:hover:bg-gray-600" href="#">
                  <span className="text-left">
                    <svg width="20" height="20" fill="currentColor" className="m-auto" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
