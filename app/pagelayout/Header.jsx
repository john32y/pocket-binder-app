...
export default function Header() {
    return (
        ...
        <header className="z-40 items-center w-full h-16 bg-white shadow-lg dark:bg-[#00CC33]">
            <div className="relative z-20 flex flex-col justify-center h-full px-3 mx-auto flex-center">
                <div className="relative flex items-center w-full pl-1 lg:max-w-68 sm:pr-2 sm:ml-0">
                    ...
                    <div className="relative flex items-center justify-end w-1/4 p-1 ml-5 mr-4 sm:mr-0 sm:right-auto">
                        ...
                        <img src="/Images/prof.jpg" className=" border-1 border-slate-950 relative block hover:scale-105 hover:shadow-lg object-cover rounded-full h-10 w-10 " />
